...
<figure class="fig-small">
  <img src="../assets/img/blog/elevator-cards.jpg" alt="A group of friends playing a card game inside a dorm elevator.">
...
<figure class="fig-pair">
  <div class="fig-pair-imgs">
    <img src="../assets/img/blog/brisket.jpg" alt="A foil tray of BBQ brisket balanced on a classroom desk.">
    <img src="../assets/img/blog/discord.jpg" alt="A Discord message from Marc reading 'Today's rendering of bringing brisket to Syntax 1,' with an AI-generated oil painting of two solemn men carrying a tray of brisket through the rain.">
  </div>
...
<figure>
  <img src="../assets/img/blog/ttt-2.jpg" alt="Ten boxes of different Triscuit flavors lined up on a conference table.">
...
<div class="post-figs">
  <figure>
    <img src="../assets/img/blog/cribsheet.jpg" alt="A completed Triscuit rating crib sheet with scores and handwritten notes for each flavor.">
    <figcaption>One voter's completed crib sheet.</figcaption>
  </figure>
  <figure>
    <img src="../assets/img/blog/ttt-5.jpg" alt="A homemade chocolate pudding pie with peppermint topping in a foil tin.">
...
<blockquote class="pullquote">
  <p>“I spent two hours of my time… just to hear that pepper wins.”</p>
  <cite>— Edith, CLMS ’27</cite>
</blockquote>

<figure>
  <img src="../assets/img/blog/ttt-7.jpg" alt="The completed tournament bracket on a whiteboard, with the grand finals between Cracked Pepper and BVB.">
